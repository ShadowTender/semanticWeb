...
?car rdfs:comment  ?comment.
?car foaf:name ?name.
filter regex(str(?comment),"Ente ")
...
Output (from http://dbpedia.org/sparql)
```
...
3. Ask if Lobster is an instance of Q1359
```
ASK { 
...
## Question 2 - Chinese famous male athletes
